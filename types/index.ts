...
export type Book = {
  ...
  // Cover design
  cover_theme:         CoverTheme | null
  cover_ornament:      string
  cover_subtitle:      string | null
  cover_font:          string | null          // ← NEW: Google Font name
  cover_image_url:     string | null          // ← NEW: Supabase storage URL
  cover_image_opacity: number | null          // ← NEW: 10–90
...
export const COVER_THEMES: Record<CoverThemeName, CoverTheme> = {
  ...
  midnight: {
    ...
    bg: '#2a3a4a',
    text: '#e8d5a3',
    accent: 'rgba(232,213,163,0.5)',
  },
  crimson: {
    name: 'crimson',
    bg: '#3d1f1f',
    text: '#f5e0c8',
    accent: 'rgba(245,224,200,0.5)',
  },
  forest: {
    name: 'forest',
    bg: '#1f3329',
    text: '#c8e8d0',
    accent: 'rgba(200,232,208,0.5)',
  },
  parchment: {
    name: 'parchment',
    bg: '#faf7f2',
    text: '#1a1208',
    accent: 'rgba(26,18,8,0.3)',
  },
  violet: {
    name: 'violet',
    bg: '#2d1a4a',
    text: '#e8c8f0',
    accent: 'rgba(232,200,240,0.5)',
  },
}
